...
* authentication tokens генерируются через `java.util.Random(9999)` с фиксированным seed, поэтому последовательность токенов детерминирована;
